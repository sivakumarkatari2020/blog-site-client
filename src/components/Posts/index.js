                        ...
                        data.map((item)=>(
                            <Box key={uuid()}>
                                ...
                                <div className={styles.likeBox}>
                                    <p style={{margin: '0 1rem 0 0',alignText: 'center'}} className={styles.reactions}><ThumbUpOffAltIcon /> : {item.post_likes}</p>
                                    <p style={{margin: '0 1rem 0 0',alignText: 'center'}} className={styles.reactions}><ThumbDownOffAltIcon /> : {item.post_dislikes}</p>
                                </div>
                            </Box>
                        ))
                    }
